...
link = "https://t.me/c/2056802156/7000-10000"
        ...
        try:
            ...
            if file.endswith(".jpg"):  
                ...
                os.remove(r"{}".format(file)) 
                 ...
                 print("uploading")
                 acc.send_video(-1002100096551,r"{}".format(file),progress=progress)
                 acc.send_video("tamilhuge",r"{}".format(file),progress=progress)
                 time.sleep(1)
                 os.remove(r"{}".format(file))    
